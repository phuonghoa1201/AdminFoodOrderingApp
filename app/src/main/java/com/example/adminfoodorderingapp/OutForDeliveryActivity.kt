...
class OutForDeliveryActivity : AppCompatActivity() {
    ...
    private lateinit var database: FirebaseDatabase // khoi tao sau
    private var listOfCompleteOrderList:ArrayList<OrderDetails> = arrayListOf() // khoi tao mot ds rong
...
//        binding.deliveryRecyclerView.layoutManager = LinearLayoutManager(this)
    ...
    private fun retrieveCompleteOrderDetail() {
        ...
        val completeOrderRef = database.reference.child("CompletedOrder").orderByChild("currentItem")
